...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] vue/forms/components/Auth.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    bookedAuthentication: function bookedAuthentication() {
	      this.$http({
	    ...
	    getUser: function getUser() {
	      var bookedApiUrl = 'http://booked-dev.library.cornell.edu/Web/Services/index.php/Users/?email=tahir.poduska@cornell.edu';
	      this.$http({
	        method: 'GET',
	        url: bookedApiUrl,
	    ...
	    createGuestUser: function createGuestUser() {
	      ...
	      this.$http({
	        ...
	        headers: this.headers,
	        dataType: 'json',
	        data: (0, _stringify2.default)(this.user)
	      }).then(function (data) {
	        console.log(data.data.userId);
	      });
	    },
	    createBookedReservation: function createBookedReservation() {
	      ...
	      this.$http({
	        ...
	        headers: this.headers,
	        dataType: 'json',
	        data: (0, _stringify2.default)({ "accessories": [], "customAttributes": [], "description": this.eventDescription, "endDateTime": this.eventEnd + ":00-0400", "invitees": [], "participants": [], "recurrenceRule": { "type": "none", "interval": 0, "monthlyType": "null", "weekdays": [], "repeatTerminationDate": "" }, "resourceId": 3,
